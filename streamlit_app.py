...
def app():
    ...
    st.title('Monster Symbol Classification')
    st.subheader('by Ma. April G. Suarnaba, BSCS 3B AI - College of ICT')
    ...
    st.write(text)
    st.write('Classifying different types of monster symbols.')
    st.write('Character recognition: Recognizing characters from different symbols.')
    st.write("""Simple image classification: Classifying simple images into categories 
             like monster-nonmonster""")
